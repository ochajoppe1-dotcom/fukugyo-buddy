...
const FAQ_GROUPS = [
  {
    ...
    items: [
      {
        q: "Free プランで何ができますか？",
        a: "AI不使用の「セルフチェック版 LP診断（27項目）」「パターン判定版 適性診断（15問）」「詐欺アラート閲覧」が無料でご利用いただけます。アカウント登録のみで使えます。AIを使った詳細な対話診断は Standard 以上のプランで提供しています。",
      },
      {
        q: "Standard と Premium の違いは？",
        a: "Standard（¥980/月）は副業を「始めて続ける」ためのプランです：AI版LP診断月10回・AI相談月10回（日記の数字を踏まえた回答可）・AI適性診断月5回・副業日記・数字レポート月1回・詐欺アラートが使えます。Premium（¥1,980/月）は「本業化を目指す人向け」のプランで、Standardに加えてAI相談月25回+会話の全記憶、レポート月2回、AI副業ロードマップ月1回、AI実務サポート月15回、緊急時テンプレ生成月10回が使えます。",
      },
      {

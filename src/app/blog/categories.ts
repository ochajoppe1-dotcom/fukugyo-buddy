...
const MAP: Record<string, CategoryId> = {
  ...
  "side-job-decline-and-boundaries": "money",
  "side-job-multiple-jobs": "money",
  ...
  "caregiving-while-side-job": "person",
  "student-side-job": "person",
  "public-servant-side-job": "person",
};

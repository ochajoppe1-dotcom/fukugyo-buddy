    ...
    <div className="max-w-2xl mx-auto px-4 py-6">
      ...
      {entries.length > 0 && (
        <button
          ...
          className="w-full bg-white border border-emerald-200 text-emerald-700 py-3 rounded-2xl font-medium hover:bg-emerald-50 transition-colors mb-4 flex items-center justify-center gap-2"
        >
          <svg
            width="18"
            height="18"
